...
# ToDo
This project is a simple Todo [PWA] (Progressive Web App) inspired by [Leon]. Perfect to learn the basics about [Vue.js], [Vuex] and [Vuetify] technologies.
...
<p align="center">
  <a href="https://github.com/Leonardoleo/ToDo" target="_blank" rel="noopener">
   </a>
</p>
...
### Clone repository
```
git clone https://github.com/Leonardoleo/ToDo.git
cd ToDo
```
